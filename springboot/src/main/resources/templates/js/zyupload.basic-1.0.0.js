...
var ZYFILE = {
	...
	funUploadFile : function(file){
		...
		// var formdata;
		// if($(this).parents(".myUploadForm").length==1){
		// 	// formdata = new FormData();
		// 	formdata=new FormData($(this).parents(".myUploadForm"))
		// }else{
		// 	//var parClass=$(this).parents(".myForm");
		// 	// formdata=new FormData($(this).parents("form"))
		// 	formdata = new FormData();
		// }
		// formdata.append("file", file);
